  ...
  return (
    <AddressContainer>
      <div className="address-container container">
        <div className="box">
            <div className="icon"><FiMail className="icons"/></div>
        ...
        <div className="box">
            <div className="icon"><HiOutlineLocationMarker className="icons"/></div>
            <div className="address-heading">Location Here</div>
            <p>182/205, SECTOR 17/18 DIVIDER ROAD, HANUMAN MANDIR GALI, GURUGRAM(122015),HARYANA</p>
        </div>
        <div className="box">
            <div className="icon"><BiPhoneCall className="icons"/></div>
